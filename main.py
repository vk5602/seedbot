...
def art():
    print(f"{Fore.LIGHTRED_EX}" + r"   " + f"{Style.RESET_ALL}")
...
░█▄▄▄█ ▀▀▀ ▀▀▀ ▀▀▀─ 　 ░█▄▄█ ▀▀▀▀ ──▀──
 ...
 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗖𝗵𝗮𝗻𝗻𝗲𝗹:- 𝗵𝘁𝘁𝗽𝘀://𝘁.𝗺𝗲/𝗜𝗻𝘀𝘁𝗮𝗻𝘁𝗘𝗮𝗿𝗻𝗶𝗻𝗴𝟭𝟲𝟵
    {Style.RESET_ALL}
    ...
    print(tree)
    print(f"{Fore.BLUE + Style.BRIGHT} • Auto Claim{Style.RESET_ALL}")
    print(f"{Fore.BLUE + Style.BRIGHT} • Auto Tasks{Style.RESET_ALL}")
    print(f"{Fore.BLUE + Style.BRIGHT} • Auto Spin{Style.RESET_ALL}")
